...
export default function Footer() {
  ...
  const govLinks = [
    ...
    { label: 'GeM Portal (Govt Orders)', href: 'https://gem.gov.in' },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            {/* Govt-ready credential badges */}
            <div className="space-y-2 mb-6">
              <div className="flex items-center gap-2 text-xs font-body">
                <Award size={13} className="text-royal-gold flex-shrink-0" />
                <span className="text-royal-bg/80">MSME Registered · Udyam No: MH-XXXX-XXXX</span>
              </div>
              <div className="flex items-center gap-2 text-xs font-body">
                <Shield size={13} className="text-royal-gold flex-shrink-0" />
                <span className="text-royal-bg/80">GST Registered · GSTIN: 27XXXXXXXXXXXXX</span>
              </div>
              <div className="flex items-center gap-2 text-xs font-body">
                <span className="text-royal-gold">🇮🇳</span>
                <span className="text-royal-bg/80">Make in India · PM Vishwakarma Certified</span>
              </div>
            </div>
            ...
            <div className="flex gap-3">
              {[
                { icon: Facebook,  href: 'https://facebook.com/durvawoodcraft',  label: 'Facebook' },
                { icon: Instagram, href: 'https://instagram.com/durvawoodcraft', label: 'Instagram' },
                { icon: Youtube,   href: 'https://youtube.com/@durvawoodcraft',  label: 'YouTube' },
          ...
          <div>
            ...
            <h4 className="font-display text-base font-bold text-royal-bg mt-7 mb-4">Government Portals</h4>
            <ul className="space-y-3">
          ...
          <div>
            ...
            <div className="space-y-4 font-body text-sm text-royal-bg/60">
              ...
              <a href={`tel:${settings.phone_numbers[0]}`} className="flex gap-2 items-center hover:text-royal-gold transition-colors">
                <Phone size={14} className="text-royal-gold flex-shrink-0" />
                <span>{settings.phone_numbers[0]}</span>
              </a>
              <a href={`mailto:${settings.email}`} className="flex gap-2 items-center hover:text-royal-gold transition-colors">
            ...
            {/* WhatsApp direct */}
            <a
              href={`https://wa.me/${waNumber}?text=Hello%20Durva%20Woodcraft!`}
              target="_blank"
              rel="noopener noreferrer"
          ...
          <div>
            ...
            <div className="font-body text-sm text-royal-bg/60 space-y-1 mb-6">
              ...
              <p>Sunday: Closed</p>
              <p className="text-royal-bg/40 text-xs mt-2">Custom order inquiries accepted 24/7 via WhatsApp</p>
            </div>
